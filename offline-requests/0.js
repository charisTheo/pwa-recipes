...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const T=Object(S.a)(l(Object(r.a)(HTMLElement)));customElements.define("dom-bind",class extends T{static get observedAttributes(){return["mutable-data"]}constructor(){if(super(),c.g)throw new Error("strictTemplatePolicy: dom-bind not allowed");this.root=null,this.$=null,this.__children=null}attributeChangedCallback(t,e,n,s){this.mutableData=!0}connectedCallback(){E()||(this.style.display="none"),this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){Object(d.a)(Object(d.a)(this).parentNode).insertBefore(this.root,this)}__removeChildren(){if(this.__children)for(let t=0;t<this.__children.length;t++)this.root.appendChild(this.__children[t])}render(){let t;if(!this.__children){if(t=t||this.querySelector("template"),!t){let e=new MutationObserver(()=>{if(t=this.querySelector("template"),!t)throw new Error("dom-bind requires a <template> child");e.disconnect(),this.render()});return void e.observe(this,{childList:!0})}this.root=this._stampTemplate(t),this.$=this.root.$,this.__children=[];for(let t=this.root.firstChild;t;t=t.nextSibling)this.__children[this.__children.length]=t;this._enableProperties()}this.__insertChildren(),this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}});var N=n(379),A=n(360);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const G=Object(s.a)(HTMLElement).prototype},360:function(t,e,n){"use strict";n.d(e,"a",(function(){return i}));n(361);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const i=Object(s.a)(t=>class extends t{_addEventListenerToNode(t,e,n){Object(r.a)(t,e,n)||super._addEventListenerToNode(t,e,n)}_removeEventListenerFromNode(t,e,n){Object(r.b)(t,e,n)||super._removeEventListenerFromNode(t,e,n)}})},393:function(t,e,n){"use strict";n.d(e,"a",(function(){return I})),n.d(e,"b",(function(){return k})),n.d(e,"c",(function(){return R}));n(361);var s=n(370),r=n(367),i=n(366),o=n(364);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function s(t,e,n){return{index:t,removed:e,addedCount:n}}function r(t,e,n,r,i,a){let l,c=0,d=0,h=Math.min(n-e,a-i);if(0==e&&0==i&&(c=function(t,e,n){for(let s=0;s<n;s++)if(!o(t[s],e[s]))return s;return n}(t,r,h)),n==t.length&&a==r.length&&(d=function(t,e,n){let s=t.length,r=e.length,i=0;for(;i<n&&o(t[--s],e[--r]);)i++;return i}(t,r,h-c)),i+=c,a-=d,(n-=d)-(e+=c)==0&&a-i==0)return[];if(e==n){for(l=s(e,[],0);i<a;)l.removed.push(r[i++]);return[l]}if(i==a)return[s(e,[],n-e)];let u=function(t){let e=t.length-1,n=t[0].length-1,s=t[e][n],r=[];for(;e>0||n>0;){if(0==e){r.push(2),n--;continue}if(0==n){r.push(3),e--;continue}let i,o=t[e-1][n-1],a=t[e-1][n],l=t[e][n-1];i=a<l?a<o?a:o:l<o?l:o,i==o?(o==s?r.push(0):(r.push(1),s=o),e--,n--):i==a?(r.push(3),e--,s=a):(r.push(2),n--,s=l)}return r.reverse(),r}(function(t,e,n,s,r,i){let a=i-r+1,l=n-e+1,c=new Array(a);for(let t=0;t<a;t++)c[t]=new Array(l),c[t][0]=t;for(let t=0;t<l;t++)c[0][t]=t;for(let n=1;n<a;n++)for(let i=1;i<l;i++)if(o(t[e+i-1],s[r+n-1]))c[n][i]=c[n-1][i-1];else{let t=c[n-1][i]+1,e=c[n][i-1]+1;c[n][i]=t<e?t:e}return c}(t,e,n,r,i,a));l=void 0;let p=[],_=e,f=i;for(let t=0;t<u.length;t++)switch(u[t]){case 0:l&&(p.push(l),l=void 0),_++,f++;break;case 1:l||(l=s(_,[],0)),l.addedCount++,_++,l.removed.push(r[f]),f++;break;case 2:l||(l=s(_,[],0)),l.addedCount++,_++;break;case 3:l||(l=s(_,[],0)),l.removed.push(r[f]),f++}return l&&p.push(l),p}function i(t,e){return r(t,0,t.length,e,0,e.length)}function o(t,e){return t===e}},397:function(t,e,n){"use strict";var s=n(381);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function st(){document.body.removeAttribute("unresolved")}"interactive"===document.readyState||"complete"===document.readyState?st():window.addEventListener("DOMContentLoaded",st);var rt=n(365),it=n(393),ot=n(367),at=n(370),lt=n(376),ct=n(364);
/**
@license
