(window.webpackJsonp=window.webpackJsonp||[]).push([[10],{358:function(e,a,p){"use strict";p.r(a);p(369),p(389);var t=p(360),o=p(374),i=p(373),l=p(378);
/**
@license
...
*/const d=t.b`
  ...
  <slot></slot>`;d.setAttribute("strip-whitespace",""),Object(n.a)({_template:d,is:"paper-button",behaviors:[s],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?r._calculateElevation.apply(this):this._setElevation(0)}})},389:function(e,a,p){"use strict";p(360);var t=p(361);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
