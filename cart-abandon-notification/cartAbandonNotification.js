...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const X=Object(r.a)(HTMLElement).prototype},function(t,e){t.exports=function(t){try{return!!t()}catch(t){return!0}}},function(t,e,n){"use strict";n(13);var r=n(1),i=(n(11),n(105)),o=n(21);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
</custom-style>`;r.setAttribute("style","display: none;"),document.head.appendChild(r.content)},function(t,e,n){"use strict";n.d(e,"a",(function(){return c}));n(13);var r=n(17),i=n(55),o=n(103);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
`,is:"iron-icon",properties:{icon:{type:String},theme:{type:String},src:{type:String},_meta:{value:a.a.create("iron-meta",{type:"iconset"})}},observers:["_updateIcon(_meta, isAttached)","_updateIcon(theme, isAttached)","_srcChanged(src, isAttached)","_iconChanged(icon, isAttached)"],_DEFAULT_ICONSET:"icons",_iconChanged:function(t){var e=(t||"").split(":");this._iconName=e.pop(),this._iconsetName=e.pop()||this._DEFAULT_ICONSET,this._updateIcon()},_srcChanged:function(t){this._updateIcon()},_usesIconset:function(){return this.icon||!this.src},_updateIcon:function(){this._usesIconset()?(this._img&&this._img.parentNode&&Object(i.a)(this.root).removeChild(this._img),""===this._iconName?this._iconset&&this._iconset.removeIcon(this):this._iconsetName&&this._meta&&(this._iconset=this._meta.byKey(this._iconsetName),this._iconset?(this._iconset.applyIcon(this,this._iconName,this.theme),this.unlisten(window,"iron-iconset-added","_updateIcon")):this.listen(window,"iron-iconset-added","_updateIcon"))):(this._iconset&&this._iconset.removeIcon(this),this._img||(this._img=document.createElement("img"),this._img.style.width="100%",this._img.style.height="100%",this._img.draggable=!1),this._img.src=this.src,Object(i.a)(this.root).appendChild(this._img))}})},function(t,e,n){"use strict";n(48),n(138),n(75),n(101);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Object(i.a)({is:"paper-icon-button",_template:o.a`
    ...
    <iron-icon id="icon" src="[[src]]" icon="[[icon]]"
               alt$="[[alt]]"></iron-icon>
  `,hostAttributes:{role:"button",tabindex:"0"},behaviors:[r.a],registered:function(){this._template.setAttribute("strip-whitespace","")},properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(t,e){var n=this.getAttribute("aria-label");n&&e!=n||this.setAttribute("aria-label",t)}})},function(t,e,n){"use strict";n(7),n(48),n(179);var r=n(12),i=n(4),o=n(108);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Object(r.a)({_template:i.a`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[o.a]})},function(t,e,n){"use strict";n(7),n(48),n(75),n(101);var r=n(12),i=n(4);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Object(r.a)({_template:i.a`
    ...
    <slot></slot>
`,is:"paper-item-body"})},function(t,e,n){"use strict";n(7),n(48),n(101),n(179);var r=n(12),i=n(4),o=n(108);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Object(r.a)({_template:i.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[o.a]})},function(t,e,n){var r=n(395);"string"==typeof r&&(r=[[t.i,r,""]]);var i={insert:("head","head"),injectType:"singletonStyleTag",singleton:!0};n(137)(r,i);r.locals&&(t.exports=r.locals)},function(t,e,n){(t.exports=n(136)(!1)).push([t.i,".snackbar-container {\n    position: fixed;\n    z-index: 15;\n    transition: bottom 0.5s ease-out;\n    bottom: 0;\n    left: 0;\n    width: 100%;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    overflow-y: auto;\n    will-change: bottom;\n    transform: translateZ(0);\n}\n.snackbar {\n    width: 96%;\n    box-sizing: border-box;\n    align-items: center;\n    display: flex;\n    justify-content: space-between;\n    text-align: left;\n    background-color: #323232;\n    color: #ffffff;\n    border-radius: 5px;\n    box-shadow: 0 3px 5px -1px rgba(0,0,0,.2), 0 6px 10px 0 rgba(0,0,0,.14), 0 1px 18px 0 rgba(0,0,0,.12);\n    padding: 10px;\n    margin: 8px auto;\n    font-weight: 300;\n    font-size: 14px;\n    transition: transform 0.5s ease-out;\n}\n.snackbar-dismiss-button {\n    padding: 6px 18px;\n    white-space: nowrap;\n    align-self: center;\n    color: var(--accent-color);\n    background-color: transparent;\n    outline: none;\n    border: none;\n    font-size: inherit;\n    font-weight: 800;\n    text-transform: uppercase;\n}\n.snackbar.hidding {\n    transform: translateY(200px);\n    z-index: -1;\n}\n.snackbar.animate-hidding {\n    transform: scale(0);\n    transform-origin: center center;\n    animation: bounce-hide-animation 0.6s cubic-bezier(0.9, 0.01, 1, 1) 0s;\n}\n.snackbar .snackbar-refresh-button {\n    color: var(--accent-color); \n    font-size: 17px;\n    margin: 0;\n    padding: 5px 9px;\n    text-decoration: none;\n    transition: all 0.35s ease-out;\n    background: none;\n    border: none;\n}\n\n@keyframes bounce-hide-animation {\n    0% {\n        transform: scale(1);   \n    }\n    30% {\n        transform: scale(1.2);\n    }\n    100% {\n        transform: scale(0);\n    }\n}\n\n@media (min-width: 767px) {\n    .snackbar {\n        width: 65%;\n    }\n    .snackbar-container {\n        bottom: 170px;\n    }\n}\n@media (min-width: 1023px) {\n    .snackbar {\n        width: 35%;\n    }\n}\n\n/* ? REMOVED\n@media (max-width: 320px) {\n    .snackbar {\n        left: calc(50% - 150px);\n        width: 280px;\n    }\n}\n@media (min-width: 410px) {\n    .snackbar {\n        left: calc(50% - 190px);\n        width: 360px;\n    }\n}\n@media (min-width: 767px) {\n    .snackbar {\n        width: 400px;\n        left: calc(50% - 195px);\n    }\n} */",""])},function(t,e,n){"use strict";n(7),n(48),n(138),n(75);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</iron-iconset-svg>`;document.head.appendChild(a.content)},function(t,e,n){"use strict";n(48),n(180);var r=n(7),i=n(44),o=n(67),a=n(50);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
