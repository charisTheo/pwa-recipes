...
Object(i.a)({is:"paper-icon-button",_template:o.a`
    ...
    <iron-icon id="icon" src="[[src]]" icon="[[icon]]"
               alt$="[[alt]]"></iron-icon>
  `,hostAttributes:{role:"button",tabindex:"0"},behaviors:[r.a],registered:function(){this._template.setAttribute("strip-whitespace","")},properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(t,e){var n=this.getAttribute("aria-label");n&&e!=n||this.setAttribute("aria-label",t)}})},function(t,e,n){"use strict";n(6),n(49),n(178);var r=n(11),i=n(4),o=n(109);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Object(r.a)({_template:i.a`
    ...
    <slot></slot>
`,is:"paper-item-body"})},function(t,e,n){"use strict";n(6),n(49),n(102),n(178);var r=n(11),i=n(4),o=n(109);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</iron-iconset-svg>`;document.head.appendChild(a.content)},function(t,e,n){"use strict";n(49),n(179);var r=n(6),i=n(45),o=n(68),a=n(51);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
